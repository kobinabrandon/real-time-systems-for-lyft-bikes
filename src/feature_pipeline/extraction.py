...
class GeodataExtractor:
    ...
    def extract(self):
        ...
        if self.feed_name == "station_information":
            ...
            saved_official_station_geodata.update(fetched_official_station_geodata)            
    ...
    def extract_official_station_geodata(self, items: list[dict[str, int | str]]) -> dict[str, str | list[float]]:
        """
        ...
        all_official_station_geodata: dict[str, str | list[float]] = {}
        ...
        for item in items:
            ...
            all_official_station_geodata |= extracted_geodata
    ...
    def save_data(self, data: dict[str, list[float]] | dict[str, str | list[float]], official: bool) -> None:
        """
    ...
    def get_saved_data(self, official: bool) -> dict[str, list[float]] | dict[str, str | list[float]]:
        """
